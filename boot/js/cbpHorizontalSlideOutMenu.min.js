...
(function(b) { var a = b.document;
    ...
    function c(f, e) { this.el = f;
        ...
        this._init() }
    c.prototype = { defaults: {}, _init: function() { this.current = -1;
            ...
            this._initEvents() }, _openMenu: function(i, k) { var g = this,
                ...
                e = function() { g.current = -1;
                    ...
                    e() } else { j.setAttribute("data-open", "open"); if (g.current !== -1) { l() }
            ...
            function f() { e._resize();
                e._resizeTimeout = null } if (this._resizeTimeout) { clearTimeout(this._resizeTimeout) }
            this._resizeTimeout = setTimeout(f, 50) }, _resize: function() { if (this.current !== -1) { this.menuBg.style.height = this.menuItems[this.current].querySelector(".cbp-hssubmenu").offsetHeight + "px" } } };
